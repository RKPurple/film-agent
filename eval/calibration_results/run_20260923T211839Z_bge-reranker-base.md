# Reranker threshold calibration — 20260923T211839Z — BAAI/bge-reranker-base
...
- model_load_seconds: 6.999348166000345
- device: mps:0
- max_length: None
- n_parameters: 278044417
- memory_method: resource.getrusage(RUSAGE_SELF).ru_maxrss (PEAK RSS; psutil not installed)
- peak_rss_mb_before_model_load: 449.78125
- peak_rss_mb_after_model_load: 854.640625
- peak_rss_mb_increase_from_model_load: 404.859375
- mps_allocated_mb_after_model_load: 1060.663818359375
- score_all_films_median_seconds: 6.144964707999861
- live_rerank_median_seconds: 0.9519798330002232
...
```
Calibration run 20260923T211839Z  reranker BAAI/bge-reranker-base  (174 films, 15 positive + 12 negative queries)
  device mps:0, 278M params, max_length None; load 7.0s; score all 174 films 6.145s/query; live rerank (median pool 28) 0.952s/query
  peak RSS after model load 855 MB (+405 MB during load); MPS allocated 1061 MB
