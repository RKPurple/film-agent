# Reranker threshold calibration — 20260923T222639Z — BAAI/bge-reranker-base
...
- Settings: RETRIEVAL_N_RESULTS=20, RRF_K=60, RERANK_TOP_N=8, CHUNK_TONE_WEIGHT=2, CHUNK_REVIEW_WEIGHT=3
- All scores are true logits; *sigmoid* = sigmoid(logit), the confidence `retrieve()` returns. The live pipeline has no confidence gate, so thresholds here are analysis only.
...
- model_load_seconds: 1.32918116700057
- device: mps:0
- max_length: None
- n_parameters: 278044417
- memory_method: resource.getrusage(RUSAGE_SELF).ru_maxrss (PEAK RSS; psutil not installed)
- peak_rss_mb_before_model_load: 450.125
- peak_rss_mb_after_model_load: 893.140625
- peak_rss_mb_increase_from_model_load: 443.015625
- mps_allocated_mb_after_model_load: 1060.663818359375
- score_all_films_median_seconds: 6.009600749999663
- live_rerank_median_seconds: 0.9502797089990054
...
```
Calibration run 20260923T222639Z  reranker BAAI/bge-reranker-base  (174 films, 15 positive + 12 negative queries)
  device mps:0, 278M params, max_length None; load 1.3s; score all 174 films 6.010s/query; live rerank (median pool 28) 0.950s/query
...
== current ==
  ...
  (i)  100% positives alive, most negatives gated: t=-5.589 logit (sigmoid 0.004): negatives gated 1/12, positives alive 15/15, film P=0.079 R=0.743 F1=0.143
  (ii) best balanced ((neg gated + pos alive)/2 = 0.650): t=-1.842 logit (sigmoid 0.137): negatives gated 10/12, positives alive 7/15, film P=0.311 R=0.200 F1=0.243
  best film-level F1: t=-2.551 logit (sigmoid 0.072): negatives gated 8/12, positives alive 8/15, film P=0.286 R=0.314 F1=0.299
...
== dedup ==
  ...
  (i)  100% positives alive, most negatives gated: t=-4.878 logit (sigmoid 0.008): negatives gated 2/12, positives alive 15/15, film P=0.094 R=0.586 F1=0.162
  (ii) best balanced ((neg gated + pos alive)/2 = 0.583): t=-4.878 logit (sigmoid 0.008): negatives gated 2/12, positives alive 15/15, film P=0.094 R=0.586 F1=0.162
  best film-level F1: t=-2.286 logit (sigmoid 0.092): negatives gated 7/12, positives alive 7/15, film P=0.250 R=0.214 F1=0.231
...
- **(i) all positives alive:** t=-5.589 logit (sigmoid 0.004): negatives gated 1/12, positives alive 15/15, film P=0.079 R=0.743 F1=0.143
- **(ii) best balanced:** t=-1.842 logit (sigmoid 0.137): negatives gated 10/12, positives alive 7/15, film P=0.311 R=0.200 F1=0.243
- **best film F1:** t=-2.551 logit (sigmoid 0.072): negatives gated 8/12, positives alive 8/15, film P=0.286 R=0.314 F1=0.299
...
|---|---|---|---|---|---|---|
| -10.197 | 0.000 | 0/12 | 15/15 | 0.027 | 1.000 | 0.053 |
| -9.712 | 0.000 | 0/12 | 15/15 | 0.029 | 1.000 | 0.056 |
| -9.227 | 0.000 | 0/12 | 15/15 | 0.029 | 0.986 | 0.057 |
| -8.742 | 0.000 | 0/12 | 15/15 | 0.031 | 0.986 | 0.061 |
| -8.258 | 0.000 | 0/12 | 15/15 | 0.032 | 0.943 | 0.063 |
| -7.773 | 0.000 | 0/12 | 15/15 | 0.036 | 0.929 | 0.069 |
| -7.288 | 0.001 | 1/12 | 15/15 | 0.040 | 0.886 | 0.077 |
| -6.803 | 0.001 | 1/12 | 15/15 | 0.045 | 0.829 | 0.086 |
| -6.318 | 0.002 | 1/12 | 15/15 | 0.054 | 0.814 | 0.101 |
| -5.834 | 0.003 | 1/12 | 15/15 | 0.066 | 0.757 | 0.122 |
| -5.349 | 0.005 | 1/12 | 14/15 | 0.084 | 0.700 | 0.150 |
| -4.864 | 0.008 | 1/12 | 13/15 | 0.098 | 0.614 | 0.169 |
| -4.379 | 0.012 | 2/12 | 12/15 | 0.112 | 0.529 | 0.185 |
| -3.894 | 0.020 | 5/12 | 11/15 | 0.129 | 0.429 | 0.199 |
| -3.409 | 0.032 | 6/12 | 9/15 | 0.160 | 0.357 | 0.221 |
| -2.925 | 0.051 | 8/12 | 8/15 | 0.216 | 0.314 | 0.256 |
| -2.440 | 0.080 | 8/12 | 7/15 | 0.299 | 0.286 | 0.292 |
| -1.955 | 0.124 | 10/12 | 7/15 | 0.304 | 0.200 | 0.241 |
| -1.470 | 0.187 | 10/12 | 5/15 | 0.294 | 0.143 | 0.192 |
| -0.985 | 0.272 | 11/12 | 5/15 | 0.375 | 0.129 | 0.191 |
| -0.501 | 0.377 | 11/12 | 3/15 | 0.357 | 0.071 | 0.119 |
| -0.016 | 0.496 | 11/12 | 2/15 | 0.375 | 0.043 | 0.077 |
| +0.469 | 0.615 | 11/12 | 2/15 | 0.500 | 0.029 | 0.054 |
| +0.954 | 0.722 | 12/12 | 2/15 | 0.500 | 0.029 | 0.054 |
| +1.439 | 0.808 | 12/12 | 1/15 | 1.000 | 0.014 | 0.028 |
...
- **(i) all positives alive:** t=-4.878 logit (sigmoid 0.008): negatives gated 2/12, positives alive 15/15, film P=0.094 R=0.586 F1=0.162
- **(ii) best balanced:** t=-4.878 logit (sigmoid 0.008): negatives gated 2/12, positives alive 15/15, film P=0.094 R=0.586 F1=0.162
- **best film F1:** t=-2.286 logit (sigmoid 0.092): negatives gated 7/12, positives alive 7/15, film P=0.250 R=0.214 F1=0.231
- **Full separation: NO** — highest negative top score +0.976, lowest positive best-relevant score -4.855 (gap -5.830)

| t (logit) | sigmoid | neg gated | pos alive | film P | film R | F1 |
|---|---|---|---|---|---|---|
| -10.197 | 0.000 | 0/12 | 15/15 | 0.027 | 1.000 | 0.053 |
| -9.727 | 0.000 | 0/12 | 15/15 | 0.028 | 0.971 | 0.055 |
| -9.256 | 0.000 | 0/12 | 15/15 | 0.030 | 0.971 | 0.057 |
| -8.786 | 0.000 | 0/12 | 15/15 | 0.032 | 0.971 | 0.061 |
| -8.316 | 0.000 | 0/12 | 15/15 | 0.034 | 0.971 | 0.066 |
| -7.846 | 0.000 | 0/12 | 15/15 | 0.036 | 0.900 | 0.069 |
| -7.375 | 0.001 | 0/12 | 15/15 | 0.040 | 0.843 | 0.076 |
| -6.905 | 0.001 | 1/12 | 15/15 | 0.046 | 0.814 | 0.088 |
| -6.435 | 0.002 | 1/12 | 15/15 | 0.054 | 0.771 | 0.101 |
| -5.965 | 0.003 | 1/12 | 15/15 | 0.063 | 0.714 | 0.115 |
| -5.494 | 0.004 | 1/12 | 15/15 | 0.076 | 0.643 | 0.136 |
| -5.024 | 0.007 | 2/12 | 15/15 | 0.091 | 0.614 | 0.159 |
| -4.554 | 0.010 | 2/12 | 13/15 | 0.096 | 0.486 | 0.161 |
| -4.083 | 0.017 | 2/12 | 12/15 | 0.121 | 0.443 | 0.190 |
| -3.613 | 0.026 | 2/12 | 9/15 | 0.133 | 0.343 | 0.192 |
| -3.143 | 0.041 | 5/12 | 7/15 | 0.153 | 0.271 | 0.196 |
| -2.673 | 0.065 | 7/12 | 7/15 | 0.200 | 0.243 | 0.219 |
| -2.202 | 0.100 | 7/12 | 6/15 | 0.245 | 0.186 | 0.211 |
| -1.732 | 0.150 | 9/12 | 5/15 | 0.294 | 0.143 | 0.192 |
| -1.262 | 0.221 | 9/12 | 4/15 | 0.318 | 0.100 | 0.152 |
| -0.792 | 0.312 | 10/12 | 3/15 | 0.286 | 0.057 | 0.095 |
| -0.321 | 0.420 | 10/12 | 3/15 | 0.429 | 0.043 | 0.078 |
| +0.149 | 0.537 | 10/12 | 2/15 | 0.667 | 0.029 | 0.055 |
| +0.619 | 0.650 | 11/12 | 0/15 | 0.000 | 0.000 | 0.000 |
| +1.089 | 0.748 | 12/12 | 0/15 | 0.000 | 0.000 | 0.000 |
